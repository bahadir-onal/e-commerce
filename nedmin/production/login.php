...
<head>
  ...
  <title>Bahadır Önal Yeni E-Ticaret Sitesi </title>
      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../netting/islem.php" method="POST">
            ...
            <h1>Bahadır Önal Yönetim Paneli </h1>
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Bahadır Önal</h1>
                <p>©Bahadır Önal Yeni E-Ticaret Sitesi</p>
              </div>
            </div>
          </form>
